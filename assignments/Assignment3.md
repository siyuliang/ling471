...
A [detailed walkthrough](https://github.com/siyuliang/ling471/blob/main/assignments/Assignment3-hints.md) is available for Parts 2 and 3. It is located in a **separate file**, to keep this file shorter.
...
1. Address any comments you received for Assignment 2 (if any), or otherwise make sure your Assignment 2 program is working correctly.
